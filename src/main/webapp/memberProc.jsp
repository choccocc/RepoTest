...
%>
<jsp:useBean id="regBean" class="BeanPackage.MemberBean" scope="application"/>
<jsp:setProperty name="regBean" property="*"  />
<jsp:setProperty name="regBean" property="id" value="???"  />
<jsp:setproperty baen="regBean" property="pwd" value="???" />
<html>
<head>
<title>회원가입 확인</title>
